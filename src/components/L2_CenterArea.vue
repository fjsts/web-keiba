<template> 
 ...
 <TabGroup>
    ...
    <TabPanels>
      <TabPanel><RegionRace area="東京"     :region="region" :day="day" :csv="data"/></TabPanel>
      <TabPanel><RegionRace area="阪神"     :region="region" :day="day" :csv="data"/></TabPanel>
      <TabPanel><RegionRace area="福島"     :region="region" :day="day" :csv="data"/></TabPanel>

      <TabPanel><RegionRace area="中京"     :region="region" :day="day" :csv="data"/></TabPanel>
      <TabPanel><RegionRace area="中山"   :region="region" :day="day" :csv="data"/></TabPanel>
      <TabPanel><RegionRace area="函館"     :region="region" :day="day" :csv="data"/></TabPanel>

      <TabPanel><RegionRace area="小倉"     :region="region" :day="day" :csv="data"/></TabPanel>
      <TabPanel><RegionRace area="新潟"     :region="region" :day="day" :csv="data"/></TabPanel>
      <TabPanel><RegionRace area="京都"     :region="region" :day="day" :csv="data"/></TabPanel>
